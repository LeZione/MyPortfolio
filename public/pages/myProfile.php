...
<html lang="en">
    <head>
        ...
        <title>Keith's Profile</title>
        <link rel="stylesheet" href="/myProfile.css"> <!-- Ensure this links correctly -->
            ...
            <div class="mainContent">
                <div class="myIntroduction">
                    ...
                    <div class="introSentence">
                        ...
                        <h3>Major in Computer Engineering Technology</h3>
                    </div>
                </div>
            </div>
